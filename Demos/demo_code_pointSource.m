...
RT.add_bundle('bundle_type',1,'nRays',50,'center_location',[-50 0],'initial_direction',0,'angle_spread',pi*2)
%RT.add_bundle('bundle_type',1,'nRays',5,'center_location',[-50 5],'initial_direction',0)
